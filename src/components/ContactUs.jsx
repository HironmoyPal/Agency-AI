...
const ContactUs = () => {
    ...
    formData.append("access_key", "03ac7105-fb8b-4e4a-8b2a-e68702c7e135");
  ...
  return (
    ...
    id ='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        <Title title='Reach out to us' desc = 'From startegy to execution , we craft digital solutions that move your buisness forward. '/>
        ...
        onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
            ...
            <button className='w-max flex gap-2 bg-primary text-white text-sm px-10 py-3 rounded-full cursor-pointer hover:scale-103 transition-all'>

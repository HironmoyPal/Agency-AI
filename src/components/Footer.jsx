...
const Footer = ({theme}) => {
  return (
    ...
    className='bg-slate-50 dark:bg-gray-900 pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
        {}
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-50'>
            <motion.div
            ...
            className='text-gray-500 dark:text-gray-600'>
                ...
                <p className='text-sm mt-2 mb-6'>Subscribe to our newsletter and get the latest news, articles, and resources delivered to your inbox weekly.</p>
        ...
        className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
            ...
            <p>Copyright 2025 © HironmoyPal - All Right Reserved.</p>

...
const Hero = () => {
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
        ...
        viewport={{ once: true}}
        className='inline-flex items-center gap-2 border-gray-300 p-1.5 pr-4 rounded-full'>
        ...
        viewport={{ once: true}}
        className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>We create meaningful connections and transform big ideas into interactive digital experiences.</motion.p>
